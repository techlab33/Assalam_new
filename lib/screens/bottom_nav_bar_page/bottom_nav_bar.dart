...
class _BottomNaveBarPageState extends State<BottomNaveBarPage> {
  ...
  List bottomNavigation = [
    ...
    {'image': 'assets/icons/menu.png', 'title': 'All Menu'}
  ];
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Image.asset(bottomNavigation[i]['image'], height: screenSize.height / 28.14, width: screenSize.height / 28.14, color: bottomIndex == i ? TColors.primaryColor : Colors.black87,),
